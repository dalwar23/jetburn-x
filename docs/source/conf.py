...
latex_documents = [
    (master_doc, "jetburn.tex", u"jetburn Documentation", u"Dalwar Hossain", "manual")
]
...
man_pages = [(master_doc, "jetburn", u"jetburn Documentation", [author], 1)]
